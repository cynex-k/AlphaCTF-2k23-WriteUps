...
def write_png_chunk(stream, chunk_type, chunk_data):
    ...
    if chunk_type ==b"IDAT":
        print(base64.b64encode(encode_png_uint31(len(chunk_data))+chunk_type+chunk_data+crc.to_bytes(4, "big")))
...
if __name__ == "__main__":
    ...
    input_rgb_data = open("chall.rgb", "rb").read()
    ...
    with open("chall1.png", "wb") as f:  # open file for writing
